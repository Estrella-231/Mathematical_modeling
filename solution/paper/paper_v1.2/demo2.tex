...
\textbf{Distribution.}  
Standardized scores are approximately normally distributed (mean 236.92, SD 43.91) with a slight right skew. \\
...
Temporal trend across seasons is as follows:

\[
\begin{array}{|c|c|c|}
\hline
\textbf{Season Range} & \textbf{Mean} & \textbf{Standard Deviation} \\
\hline
Seasons 1-10 & 218.4 & 48.2 \\
Seasons 11-20 & 232.7 & 42.1 \\
Seasons 21-34 & 248.9 & 38.6 \\
\hline
\end{array}
\]

Season effects are controlled through fixed effects.

\textbf{Judge Consistency.}  
Inter-judge Spearman correlation is as follows:\\

\begin{table}[h]
\centering
\begin{tabular}{c c c}
\toprule
\textbf{Judge Comparison} & \textbf{Spearman Correlation} ($\rho$) & \textbf{p-value} \\
\midrule
...
High agreement justifies using aggregated judge scores.

\textbf{Within-week Variance.}  
The average within-week standard deviation is 28.3, with a coefficient of variation of 11.9\%, providing sufficient separation to distinguish performances.
